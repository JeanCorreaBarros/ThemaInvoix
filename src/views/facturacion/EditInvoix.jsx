...
const EditInvoix = () => {
    ...
    /** Capturar number y prefix por url  */
    const [numberX, setNumber] = useState('');
    const [prefix, setPrefix] = useState('');
    // Extraer el número de la cadena
    const numeroFactura = numberX.replace(/[^0-9]/g, '');

    // Get Cabecera de Factura 
    const [cabeceraFactura, setCabeceraFactura] = useState('');
    //  Get Items  de Factura 
    const [ItemsFactura, setItemFactura] = useState('');
    ...
    /** Obtener data de factura a editar  */
   useEffect(() => {
        ...
        fetch("https://api.invoix.co/v1/getinvoices", requestOptions)
    ...
    const handleGuardarFacturaCabecera = () => {
        ...
        formDataCabeceraFactura.append('paymentOption', paymentOption || '0');
            ...
            .then((response) => {
                if (response.ok) {
                    ...
                    response.json().then((data) => {
                        ...
                        const timeoutReload = 4000; // 2 segundos
    ...
    /*const sumarImpuesto = () => {
        const uniqueTaxValues = [];
        items.forEach((item) => {
            if (!uniqueTaxValues.includes(item.tax)) {
                uniqueTaxValues.push(item.tax);
            }
        });
        setImpuesto(uniqueTaxValues);
    };*/
    const [impuestoHistorial, setImpuestoHistorial] = useState([]);
    /*const sumarImpuesto = () => {
        const uniqueTaxValues = [];
        ...
        const updatedImpuesto = [...impuesto]; // Crear una copia del array impuesto existente

        uniqueTaxValues.forEach((tax) => {
            if (!updatedImpuesto.includes(tax)) {
                updatedImpuesto.push(tax);
            }
        });

        console.log(impuesto)
        console.log(uniqueTaxValues)
        console.log(updatedImpuesto)

        uniqueTaxValues.length = 0; // Limpiar el arreglo uniqueTaxValues

        setImpuesto(updatedImpuesto);
    };*/
...
s
    ...
    const taxData = [
        ...
        },
        {
            ...
            "typeTax": "IVA",
            "percentage": "5.00",
            "description": "TARIFA 5% servicios\r\n\r\n"
        },
        {
            "nameTax": "IVA5BIEN",
            "typeTax": "IVA",
            "percentage": "5.00",
            "description": "TARIFA 5% bienes\r\n\r\n"
        },
        {
            "nameTax": "IVA8",
            "typeTax": "IVA",
            "percentage": "8.00",
            "description": "IVA 8% BAR-REST"
        },
        {
            "nameTax": "IVA4",
            "typeTax": "IVA",
            "percentage": "4.00",
            "description": "IVA 4% MOVIL"
        }
    ];
    ...
    return (
        <main className="">
            <div className="px-16 mt-5 flex justify-start">
                <h2 className="font-semibold text-gray-600 text-4xl">Editar Factura</h2>
            </div>
            <div class="pt-6 px-4">
                        ...
                        <div className='w-[1500px] h-full  bg-gray-50 shadow-2xl rounded-lg z-10'>
                            ...
                            <div className='w-full flex justify-around px-20 pt-20'>
                                ...
                                <div className='flex items-center justify-end w-4/12 '>
                                    ...
                                    <input className='w-2/6 h-10 px-3 rounded-md bg-gray-100' disabled type="text" value={numberX} />
                                </div>
                            </div>
                            ...
                            <div className='w-full flex flex-col justify-between px-20 py-10 '>
                                <div class="flex flex-col px-5 gap-5 items-center justify-center w-full bg-gray-100 shadow-lg py-5  rounded ">
                                    <div className="w-full flex gap-2">
                                        ...
                                        <div className='w-3/12'>
                                            <label for="percentage" class="block mb-2 text-sm font-medium text-gray-900">Descuento</label>
                                            <input
                                                type="number"
                                                id="percentage"
                                                name="percentage"
                                        ...
                                        <div className='w-3/12'>
                                            ...
                                            <textarea
                                                ...
                                                onChange={handleInputChange}
                                                class="bg-gray-50 border h-10 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                                required=""
                                            />
                                        </div>
                                        <div className='w-3/12'>
                            ...
                            <div className='w-full flex justify-around px-20 pt-5 mb-32'>
