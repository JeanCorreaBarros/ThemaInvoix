...
const NavBar = ({ isVisible, setIsVisible }) => {
  ...
  return (
    <>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 fixed z-30 w-full">
        <div className="flex flex-wrap justify-between items-center">

          <div className="flex justify-start items-center">
            <button id="toggleSidebar" onClick={toggleVisibilitySidebar} aria-expanded="true" aria-controls="sidebar" className="hidden p-2 mr-3 text-gray-600 rounded cursor-pointer lg:inline hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
            ...
            <button aria-expanded="true" aria-controls="sidebar" onClick={toggleVisibilitySidebar} className="hidden p-2 mr-2 text-gray-600 rounded-lg cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <a href="/" className="flex  items-center ml-44 md:ml-5 mr-4">
              <img src="https://i.ibb.co/6v80KFy/logo-nexus-it.png" className="mr-2 h-8" alt="Invoix Logo" />
              <span className="self-center text-[32px] font-semibold whitespace-nowrap dark:text-white">
                <span className="text-green-500 font-bold">IN</span>VOIX
              </span>
            </a>
          ...
          <div className="hidden md:flex items-center lg:order-2">
            <button onClick={() => handleShow()} type="button" className="hidden sm:inline-flex items-center justify-center text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-xs px-5 py-1.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"><svg aria-hidden="true" className="mr-1 -ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd"></path></svg>Crear Nuevo</button>
            ...
            {/** Btn Notificaciones */}
            <button type="button" onClick={ToggleModalNotification} data-dropdown-toggle="notification-dropdown" className=" p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
            ...
            <div className={`${modalNotification ? "hidden" : "absolute top-[52px] right-28 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700"}`} id="notification-dropdown">
              <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-50">
                Notifications
              </div>
              <div>
                <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                  ...
                  <div className="pl-3 w-full">
                    ...
                    <div className="text-xs font-medium text-primary-700 dark:text-gray-50">a few moments ago</div>
                  </div>
                </a>
                <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                  <div className="flex-shrink-0">
                  ...
                  <div className="pl-3 w-full">
                    ...
                    <div className="text-xs font-medium text-primary-700 dark:text-gray-50">10 minutes ago</div>
                  </div>
                </a>
                <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                  <div className="flex-shrink-0">
                  ...
                  <div className="pl-3 w-full">
                    ...
                    <div className="text-xs font-medium text-primary-700 dark:text-gray-50">44 minutes ago</div>
                  </div>
                </a>
                <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                  <div className="flex-shrink-0">
                  ...
                  <div className="pl-3 w-full">
                    ...
                    <div className="text-xs font-medium text-primary-700 dark:text-gray-50">1 hour ago</div>
                  </div>
                </a>
                <a href="#" className="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-600">
                  ...
                  <div className="pl-3 w-full">
                    ...
                    <div className="text-xs font-medium text-primary-700 dark:text-gray-50">3 hours ago</div>
                  </div>
                </a>
              </div>
              <a href="#" className="block py-2 text-base font-normal text-center text-gray-900 bg-gray-50 hover:bg-blue-500 dark:bg-gray-700 dark:text-white dark:hover:underline">
            ...
            {/** Modal App */}
            {/*<div className=" absolute top-[52px] right-8 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
            ...
            {/** Btn Perfil */}
            <button type="button" onClick={ToggleModalPerfil} className="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
              <span className="sr-only">Open user menu</span>
              <img className="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo" />
            </button>

            {/** Modal Perfil */}
            <div className={`${modalPerfil ? "hidden" : "absolute top-[52px] right-2 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"}`} id="dropdown">
              ...
              <ul className="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                ...
                <li>
                  <a href="perfile" className="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-green-600 dark:text-gray-400 dark:hover:text-white font-bold">Datos de Perfil</a>
                </li>
              </ul>
              <ul className="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                <li>
                  <a href="#" className="flex justify-between items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-green-600 dark:hover:text-white font-bold">
                    <span className="flex items-center">
                      <svg aria-hidden="true" className="mr-2 w-5 h-5 text-primary-600 dark:text-green-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12.395 2.553a1 1 0 00-1.45-.385c-.345.23-.614.558-.822.88-.214.33-.403.713-.57 1.116-.334.804-.614 1.768-.84 2.734a31.365 31.365 0 00-.613 3.58 2.64 2.64 0 01-.945-1.067c-.328-.68-.398-1.534-.398-2.654A1 1 0 005.05 6.05 6.981 6.981 0 003 11a7 7 0 1011.95-4.95c-.592-.591-.98-.985-1.348-1.467-.363-.476-.724-1.063-1.207-2.03zM12.12 15.12A3 3 0 017 13s.879.5 2.5.5c0-1 .5-4 1.25-4.5.5 1 .786 1.293 1.371 1.879A2.99 2.99 0 0113 13a2.99 2.99 0 01-.879 2.121z" clipRule="evenodd"></path></svg> Pro version
                    </span>
                    <svg aria-hidden="true" className="w-5 h-5  dark:text-green-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
                  </a>
                </li>
              ...
              <ul className="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                <li>
                  <a href="#" onClick={handleCloseSession} className="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-green-600 dark:hover:text-white font-bold">Cerrar Session </a>
                </li>
              </ul>
            </div>
